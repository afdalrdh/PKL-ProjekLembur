      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-6 col-sm-offset-1">
            <form class="form-horizontal" method="POST" action="<?php echo base_url()."admin/prosesapproval"; ?>">
              <div class="form-group" hidden>
                <label for="nama" class="col-sm-3 control-label">Jamtonly : </label>
                <div class="col-sm-2">
                  <input type="text" class="form-control" name="jamonly" readonly value="<?php echo $format_waktu ?>">
                </div>
              </div>
              <div class="form-group" hidden>
                <label for="nama" class="col-sm-3 control-label">Jamtot : </label>
                <div class="col-sm-2">
                  <input type="text" class="form-control" name="jamtot" readonly value="<?php echo $format_waktu+$jamtot ?>">
                </div>
              </div>
              <div class="form-group" hidden>
                <label for="nama" class="col-sm-3 control-label">Uangtot : </label>
                <div class="col-sm-2">
                  <input type="text" class="form-control" name="uangtot" readonly value="<?php echo ($format_waktu+$jamtot)*2000 ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <label for="jam2" class="col-sm-1 control-label">s/d</label>
                  ...
                  <div class="col-sm-2">
                    <label id="different" class="control-label text-primary"><?php echo $format_waktu ?> jam</label>
                  </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="nik" class="col-sm-3 control-label">Keterangan Kembali Pemtug : </label>
                <div class="col-sm-9">
